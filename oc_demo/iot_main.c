...
#define CN_IOT_SERVER    "192.168.18.57"
...
static const char *g_defaultSubscribeTopic[] = {
    "mqtt_huaweicar_demo/"CONFIG_DEVICE_ID"/sys/messages/down",
    "mqtt_huaweicar_demo/"CONFIG_DEVICE_ID"/sys/properties/set/#",
    "mqtt_huaweicar_demo/"CONFIG_DEVICE_ID"/sys/properties/get/#",
    "mqtt_huaweicar_demo/"CONFIG_DEVICE_ID"/sys/shadow/get/response/#",
    "mqtt_huaweicar_demo/"CONFIG_DEVICE_ID"/sys/events/down",
    "mqtt_huaweicar_demo/"CONFIG_DEVICE_ID"/sys/commands/#"
};
...
static void MainEntryProcess(void)
{
    ...
    char *clientID = "huaweicar1";
    char *userID = "admin";
    char *userPwd = "12345678";
